        ...
        <Container>
          <div className='flex flex-col lg:flex-row lg:justify-between items-center'>
            ...
            <div className='lg:w-1/2 flex justify-end 2xl:justify-center relative mt-24 lg:mt-0 mb-52 md:mb-72 lg:mb-0'>
              ...
              <img src={aboutImg} alt="Image" className='w-[100px] md:w-[240px] lg:w-[215px] xl:w-[300px] 2xl:w-[375px] absolute bottom-[-32px] md:bottom-[-145px] lg:bottom-[60px] xl:bottom-[65px] 2xl:bottom-[90px] right-[157px] md:right-[255px] lg:right-[140px] xl:right-[175px] 2xl:right-[210px]' />
            </div>
