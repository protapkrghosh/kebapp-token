...
import card4logo from '@/assets/howtobuy/image 198.png'
      ...
      <Container>
        ...
        <div className='flex border-t-[2px] border-[#418077]'>
          ...
          <div className='2xl:w-[50%] flex items-center gap-8'>
            ...
            <p className='text-[28px] font-bold leading-[33.6px]'><span className='bg-clip-text text-transparent bg-gradient-to-l from-[#f2f817] to-[#1bc5df]'>Buy  KEBAB token</span></p>
          </div>
          {/* card contain section  */}
          <div className='2xl:w-[50%] bg-[#0A1E25] rounded-b-md'>
            <p className='text-[18px] text-[#C7C6C6] xl:max-w-[600px] py-5 pl-[40px]'>Buy KEBAB token and join the meme revolution! Embrace the laughter, fun and potential gains. Secure your spot in the meme coin world. Hurry up!</p>
          </div>
        </div>
      </Container>
    </div>
