        ...
        <div className='flex'>
          ...
          <div className='xl:w-[60%]'>
            ...
            <div className='mb-[32px] flex justify-between relative'>
              ...
              <p className='text-[#000] text-[14.833px] font-semibold leading-[17.8px] absolute 2xl:bottom-[65px] 2xl:left-[380px] z-50'>60%</p>
            ...
            <div className='mb-[32px] flex justify-between relative'>
              ...
              <p className='text-[#000] text-[14.833px] font-semibold leading-[17.8px] absolute 2xl:bottom-[65px] 2xl:left-[380px] z-50'>10%</p>
            ...
            <div className='mb-[32px] flex justify-between relative'>
              ...
              <p className='text-[#FFF] text-[14.833px] font-semibold leading-[17.8px] absolute 2xl:bottom-[45px] 2xl:left-[380px] z-50'>30%</p>
