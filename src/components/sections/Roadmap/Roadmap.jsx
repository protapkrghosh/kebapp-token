        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="space-y-4 ml-9 mt-9">
              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">Public Presale</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">Dexscreener and Birdseye Update</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">$20M+ Daily Volume</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">10000+ Holders</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-9 mt-9">
              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">Trending on X</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">CG CMC Listing</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">NFT Airdrop</p>
              </div>

              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-l from-[#F4F914] to-[#19C5E2] rounded-full mr-3" />
                <p className="text-white text-[20px] font-normal">100000+ Holders</p>
              </div>
            </div>
          </div>
        </div>
